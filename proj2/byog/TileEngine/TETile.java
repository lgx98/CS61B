...
public class TETile {
    ...
    public static class noEffect implements TileEffect {
        @Override
        public TETile applyEffect(TETile input) {
            return input;
        }
    }

    public static class colorNoise implements TileEffect {
        ...
        public colorNoise(int dColor) {
            this(dColor, dColor, dColor);
        }

        public colorNoise(int dr, int dg, int db) {
            this(dr, dg, db, new Random(0));
        }

        public colorNoise(int dr, int dg, int db, Random r) {
            this.dr = dr;
            this.dg = dg;
            this.db = db;
            this.r = r;
        ...
        @Override
        public TETile applyEffect(TETile tile) {
            return colorVariant(tile, dr, dg, db, r);
        }
    }
}
